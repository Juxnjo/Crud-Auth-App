            ...
            <ul className="flex gap-x-2">
                { isAuthenticated ? (
                    <>
                        ...
                        <li>
                            <Link to='/add-task' className='bg-purple-500 w-full hover:bg-purple-700 text-white font-semibold my-2 py-2 px-4 rounded-md'>Add Task</Link>
                        </li>
                        <li>
                            <Link to='/' onClick={() => {
                                logout( ) 
                            }} className='bg-zinc-500 w-full hover:bg-zinc-700 text-white font-semibold my-2 py-2 px-4 rounded-md'>Logout</Link>
                        </li>
                    </>
                ) : (
                    <>
